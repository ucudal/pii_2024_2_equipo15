...
<<<<<<< HEAD
    ...
    private static Ataques Psicoonda = new Ataques("Psicoonda", 80, Psiquico); //Creamos un ataque llamado Psicoonda
    
=======
    private static Ataques Placaje = new Ataques("Placaje", 40, Normal, false); //Creamos un ataque llamado Placaje
    ...
    private static Ataques Ascuas = new Ataques("Ascuas", 40, Fuego, true); //Creamos un ataque llamado Ascuas
    private static Ataques RayoBurubuja = new Ataques("Rayo Burbuja", 65, Agua, false); //Creamos un ataque llamado Rayo Burbuja
    private static Ataques Surf = new Ataques("Surf", 90, Agua, false); //Creamos un ataque llamado Surf
    private static Ataques HojaAfilada = new Ataques("Hoja Afilada", 55, Planta, false); //Creamos un ataque llamado Hoja Afilada
    private static Ataques Energibola = new Ataques("Energibola", 80, Planta, false); //Creamos un ataque llamado Rayo Solar
    private static Ataques Trueno = new Ataques("Trueno", 110, Electrico, true); //Creamos un ataque llamado Trueno
    private static Ataques Chispazo = new Ataques("Chispazo", 65, Electrico, true); //Creamos un ataque llamado Chispazo
    private static Ataques Terremoto = new Ataques("Terremoto", 100, Tierra, false); //Creamos un ataque llamado Terremoto
    private static Ataques DisparoLodo = new Ataques("Disparo Lodo", 55, Tierra, false); //Creamos un ataque llamado Disparo Lodo
    private static Ataques AlaDeAcero = new Ataques("Ala de Acero", 70, Volador, false); //Creamos un ataque llamado Ala de Acero
    private static Ataques Tornado = new Ataques("Tornado", 40, Volador, false); //Creamos un ataque llamado Tornado
    private static Ataques CorteNoche = new Ataques("Corte Noche", 70, Normal, false); //Creamos un ataque llamado Corte Noche
    private static Ataques Triturar = new Ataques("Triturar", 80, Normal,false); //Creamos un ataque llamado Triturar
    private static Ataques LanzaMugre = new Ataques("Lanza Mugre", 65, Veneno, true); //Creamos un ataque llamado Lanza Mugre
    private static Ataques BombaLodo = new Ataques("Bomba Lodo", 90, Veneno, true); //Creamos un ataque llamado Bomba Lodo
    private static Ataques RocaAfilada = new Ataques("Roca Afilada", 100, Roca, false); //Creamos un ataque llamado Roca Afilada
    private static Ataques Avalancha = new Ataques("Avalancha", 75, Roca, false); //Creamos un ataque llamado Avalancha
    private static Ataques ColaFerrea = new Ataques("Cola Ferrea", 100, Dragon, false); //Creamos un ataque llamado Cola Ferrea
    private static Ataques CabezaDeHierro = new Ataques("Cabeza de Hierro", 80, Roca, false); //Creamos un ataque llamado Cabeza de Hierro
    private static Ataques GarraDragon = new Ataques("Garra Dragon", 80, Dragon, false); //Creamos un ataque llamado Garra Dragon
    private static Ataques CometaDraco = new Ataques("Cometa Draco", 130, Dragon, false); //Creamos un ataque llamado Cometa Draco
    private static Ataques PuñoHielo = new Ataques("Puño Hielo", 75, Hielo, false); //Creamos un ataque llamado Puño Hielo
    private static Ataques RayoHielo = new Ataques("Rayo Hielo", 90, Hielo, false); //Creamos un ataque llamado Rayo Hielo
    private static Ataques SombraVil = new Ataques("Sombra Vil", 40, Fantasma, false); //Creamos un ataque llamado Sombra Vil
    private static Ataques BolaSombra = new Ataques("Bola Sombra", 80, Fantasma, false); //Creamos un ataque llamado Bola Sombra
    private static Ataques ABocajarro = new Ataques("A Bocajarro", 120, Lucha, false); //Creamos un ataque llamado A Bocajarro
    private static Ataques Ventisca = new Ataques("Ventisca", 110, Hielo, false); //Creamos un ataque llamado Ventisca
    private static Ataques HidroBomba = new Ataques("Hidro Bomba", 110, Agua, false); //Creamos un ataque llamado Hidro Bomba
    private static Ataques Impactrueno = new Ataques("Impactureno", 40,Electrico, true); //Creamos un ataque llamado Impactrueno
    private static Ataques Picotazo = new Ataques("Picotazo", 35, Volador, false); //Creamos un ataque llamado Picotazo
    private static Ataques Garraumbria = new Ataques("Garra Umbria", 60, Bicho, false); //Creamos un ataque llamado Garra Umbria
    private static Ataques GolpeMordaza = new Ataques("Golpe Mordaza", 90, Bicho, false); //Creamos un ataque llamado Golpe Mordaza
    private static Ataques Esporas = new Ataques("Esporas", 40, Planta, true); //Creamos un ataque llamado Golpe Mordaza
>>>>>>> ef667aa355a0e115a3a7c7d6fb7ef0bc1cc48e8f
