...
public class Logica
{
    ...
    private static Ataques HojaAfilada = new Ataques("Hoja Afilada", 55, Planta, true); //Creamos un ataque llamado Hoja Afilada
    private static Ataques RayoSolar = new Ataques("Rayo Solar", 120, Planta, false); //Creamos un ataque llamado Rayo Solar
    private static Ataques Trueno = new Ataques("Trueno", 110, Electrico, true); //Creamos un ataque llamado Trueno
    private static Ataques Chispazo = new Ataques("Chispazo", 65, Electrico,false); //Creamos un ataque llamado Chispazo
    private static Ataques Terremoto = new Ataques("Terremoto", 100, Tierra, true); //Creamos un ataque llamado Terremoto
    private static Ataques DisparoLodo = new Ataques("Disparo Lodo", 55, Tierra,true); //Creamos un ataque llamado Disparo Lodo
    private static Ataques AlaDeAcero = new Ataques("Ala de Acero", 70, Volador,false); //Creamos un ataque llamado Ala de Acero
    private static Ataques Tornado = new Ataques("Tornado", 40, Volador,true); //Creamos un ataque llamado Tornado
    private static Ataques CorteNoche = new Ataques("Corte Noche", 70, Normal,true); //Creamos un ataque llamado Corte Noche
    private static Ataques Triturar = new Ataques("Triturar", 80, Normal,true); //Creamos un ataque llamado Triturar
    private static Ataques LanzaMugre = new Ataques("Lanza Mugre", 65, Veneno,false); //Creamos un ataque llamado Lanza Mugre
    private static Ataques BombaLodo = new Ataques("Bomba Lodo", 90, Veneno,false); //Creamos un ataque llamado Bomba Lodo
    ...
    private static Ataques CometaDraco = new Ataques("Cometa Draco", 130, Dragon, true); //Creamos un ataque llamado Cometa Draco
    ...
    private static Ataques SombraVil = new Ataques("Sombra Vil", 40, Fantasma,true); //Creamos un ataque llamado Sombra Vil
